...
public class Principal{
	...
	public static void main(String[] args) throws NamingException, ServiciosException {
		...
		//Rutas de acceso a los BeanRemote pertenecientes al server
		...
		// Lanzamiento de ventana de login
		Login loginWindow = new Login();
		loginWindow.getFrame().setVisible(true);
		
		//Creacion de datos y persistencia en la base
		//Se crean ITRs y se persisten
		//Se crean y persisten usuarios de los 3 tipos posibles
		//Se crean tipos de constancia y se persisten
		//Se crean eventos y se los asigna a estudiantes
		//Se crean 2 reclamos y se le asignan a estudiantes
		ITR itr1 = new ITR();
		ITR itr2 = new ITR();
		ITR itr3 = new ITR();
