...
public class ListarTiposDeConstancia extends JFrame
    ...
    public ListarTiposDeConstancia(USUARIO userEntrar) throws NamingException, ServiciosException {
        ...
        btnSolicitar.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		try {
					MODELOCONSTANCIA modelo = modeloBean.findSol(Integer.parseInt(tabla.getValueAt(tabla.getSelectedRow(), 0).toString())).get(0);
					
					try {
						CrearModelosConstancia modW = new CrearModelosConstancia((ANALISTA) userEntrar, modelo);
    ...
    private void crearTablaPersona() {
		String[] columnas = { "ID", "Tipo", "Detalle"};
		tabla = new JTable();
	...
	private void agregarDatosLista() throws NamingException {
		...
		Object[] datosFila = { "", "", ""};
		List<MODELOCONSTANCIA> list = null;
		try {
